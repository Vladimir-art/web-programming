    ...
    for (key in content) {
        ...
        <li style="width: 210px" class="d-flex flex-column m-1 p-1 border bg-body rounded">
            ...
            <div class="d-flex flex-column m-1 p-1 text-center justify-content-between">
                ...
                <p class="card-text" style="margin: 0; font-family: 'Nunito Sans', sans-serif; font-weight: 300;">Цена <p class="card-text font-weight-bold price" style="margin: 0; font-family: 'Nunito Sans', sans-serif; font-weight: 600;">${content[key].price} €.</p></p>
